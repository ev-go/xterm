...
=======
	...
	// fmt.Println("Пароль") fmt.Scanf("%s\n", &Pass) terminalInputSlice :=
	// []string{"Param", "value", "value1", "value2"}
	// fmt.Println(terminalInputSlice[0]) fmt.Println(terminalInputSlice[1])
